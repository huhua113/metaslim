...
const emptyDose: DoseData = { dose: '', weightLossPercent: 0, nauseaPercent: 0, vomitingPercent: 0, diarrheaPercent: 0, constipationPercent: 0, saePercent: 0 };
        ...
        <form onSubmit={handleSubmit} className="flex-grow contents">
          <div className="p-6 max-h-[70vh] overflow-y-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              ...
              <div>
                <label htmlFor="manual_formulation" className={formLabelStyle}>剂型</label>
                <select id="manual_formulation" name="formulation" value={formData.formulation} onChange={handleChange} className={formInputStyle}>
