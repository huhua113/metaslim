      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          ...
          <ul className="mt-2 text-sm space-y-1">
            ...
            <li className="flex justify-between"><span>剂型:</span> <span className="font-medium text-slate-700">{study.formulation}</span></li>
            <li className="flex justify-between"><span>频率:</span> <span className="font-medium text-slate-700">{study.frequency}</span></li>
